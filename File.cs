...
namespace Ssepan.Graphics
{
    public static class File
    {
        ...
        public static void RotateImageFile(String filename, RotateFlipType rotateFlipType)
        {
            ...
            try
            {
                if (!File.LoadImageUnlocked(ref image, filename, ref errorMessage))
                {
        ...
        /// <summary>
        /// Get image page count info
        /// </summary>
        /// <param name="path"></param>
        /// <returns></returns>
        public static Int32 ImagePageCount
        (
            String path
        )
        {
            ...
            try
            {
                ...
                returnValue = image.GetFrameCount(FrameDimension.Page);
            }
            catch (Exception ex)
            {
                Log.Write(ex, MethodBase.GetCurrentMethod(), EventLogEntryType.Error);
